...
const AdminDashboardPage = () => {
  ...
  // Data antrean untuk grafik & tabel aktivitas
  ...
  const metrics = [
    ...
    },
    {
      ...
      description: "Status Menunggu / CheckIn (PRD DSH-04)",
      icon: Clock,
      tone: "warning",
    },
    {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {/* Grafik proporsi antrean */}
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Proporsi Antrean Hari Ini</CardTitle>
            <CardDescription>
              Distribusi status antrean pasien
            </CardDescription>
          </CardHeader>
          <CardContent>
            {queuesLoading ? (
